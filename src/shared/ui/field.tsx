...
export const FieldSet: FC<ComponentPropsWithRef<'fieldset'>> = ({
  className,
  ...props
}) => {
  return (
...
type TFieldLegendProps = ComponentPropsWithRef<'legend'> & {
  variant?: 'legend' | 'label';
};

export const FieldLegend: FC<TFieldLegendProps> = ({
  className,
  variant = 'legend',
  ...props
}) => {
...
export const FieldGroup: FC<ComponentPropsWithRef<'div'>> = ({
  className,
  ...props
}) => {
  return (
...
type TFieldProps = ComponentPropsWithRef<'div'> &
...
export const FieldContent: FC<ComponentPropsWithRef<'div'>> = ({
  className,
  ...props
}) => {
  return (
...
export const FieldLabel: FC<ComponentPropsWithRef<typeof Label>> = ({
  className,
  ...props
}) => {
  return (
...
export const FieldTitle: FC<ComponentPropsWithRef<'div'>> = ({
  className,
  ...props
}) => {
  return (
...
export const FieldDescription: FC<ComponentPropsWithRef<'p'>> = ({
  className,
  ...props
}) => {
  return (
...
export const FieldSeparator: FC<ComponentPropsWithRef<'div'>> = ({
  children,
  className,
  ...props
}) => {
...
export const FieldError: FC<ComponentPropsWithRef<'div'>> = ({
  className,
  children,
  ...props
}) => {
